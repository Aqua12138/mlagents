...
class ParticlePositionChannel(SideChannel):
    def __init__(self):
        ...
        self.targetDistribution = self.get_targetPositions("pour")
        self.workArea = [[-2.0, 2.0], [0.0, 2.0], [-2.0, 2.0]] # [[-0.6, 0.6], [0.4, 0.7], [-0.6, 0.6]] | [[-1.2, 1.2], [0.4, 0.7], [-1.2, 1.2]]
        self.pixel_size = [20, 10, 20] # [24, 3, 24]
